...
'Save ','position',[0.06 0.39 0.1 0.05]) 
...
'Save ','position',[0.2 0.39 0.1 0.05],'callback',{@training1 edit4 edit5 edit6}) 
...
'Klasifikasi ','position',[0.42 0.45 0.1 0.05])
endfunction
...
function GLCM(hObject, eventdata,edit4, edit5, edit6)
  ...
  dissimilarity= dissimilarity/10000000
  set(edit6,'string',num2str(dissimilarity));
  
endfunction

function training1(hObject, eventdata,push4, edit4, edit5, edit6, axis1)
...
function training2(hObject, eventdata,push7, edit4, edit5, edit6, ax1)
  
  kontras2=str2num(get(edit5,'string'))
  homogen2=str2num(get(edit6,'string'))
  diss2=str2num(get(edit7,'string'))
  ciri1=[kontras2,homogen2,diss2]
  save ciri2.mat ciri2
  
endfunction

function klasifikasi(hObject,eventdata,push8, edit4,edit5,edit6,ax3)
  
  kontras_hasil=str2num(get(edit4,'string'))
  diss_hasil=str2num(get(edit5,'string'))
  homogen_hasil=str2num(get(edit6,'string'))
  ciri_img=[kontras_hasil,diss_hasil,homogen_hasil]
  
  eu1 = (ciri1(1)-kontras_hasil)^2+(ciri1(2)-homogen_hasil)^2+(ciri1(3)-diss_hasil)^2
  eu2 = (ciri2(1)-kontras_hasil)^2+(ciri2(2)-homogen_hasil)^2+(ciri2(3)-diss_hasil)^2
  
  %membandingkan
  if eu1<eu2 
    gambar1=imread('bunga matahari.jpg');
    axes3(ax3)
    imshow(gambar1)
    
  else eu1>eu2
    gambar2=imread('bunga daisy.jpg');
    ixes3(ax3)
    imshow(gambar2)
  endif
